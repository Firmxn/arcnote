                    ...
                    <div className="text-center mb-10 md:mb-6">
                        ...
                        <p className="text-text-neutral/60 dark:text-text-secondary text-sm md:text-xs">
                            {mode === 'login'
                                ...
                                : (mode === 'register' ? 'Create an account to sync your data' : 'Enter your email to receive reset link')}
                        </p>
                    </div>
                        ...
                        {mode !== 'forgot_password' && (
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    // Use explicit check list to satisfy TypeScript
                                    required={['login', 'register'].includes(mode)}
                                    minLength={6}
                                />
                            </div>
                        )}
                        ...
                        {mode === 'login' && (
                            <div className="flex justify-end -mt-1">
                                <button
                                    ...
                                    className="text-xs text-text-neutral/60 hover:text-accent transition-colors font-medium"
                                >
                                    Forgot Password?
                                </button>
                            </div>
                        ...
                        <div className="text-sm text-text-neutral/60 dark:text-text-secondary">
                            {mode === 'login' ? (
                                <>
                                    ...
                                    <button className="text-accent font-bold hover:underline focus:outline-none" onClick={() => { setMode('register'); setError(null); setMessage(null); }}>
                                        Sign Up
                                    </button>
                                </>
                            ) : mode === 'register' ? (
                                <>
                                    ...
                                    <button className="text-accent font-bold hover:underline focus:outline-none" onClick={() => { setMode('login'); setError(null); setMessage(null); }}>
                                        Sign In
                                    </button>
                                </>
                            ) : (
