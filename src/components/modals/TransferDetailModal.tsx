...
export const TransferDetailModal: React.FC<TransferDetailModalProps> = ({
    ...
    const handleCancelClick = () => {
        // Tutup modal detail, buka dialog konfirmasi
    ...
    const handleCancelDialogCancel = () => {
        // Tutup dialog, buka kembali modal detail
        setShowCancelConfirm(false);
        setShowDetailModal(true);
    };
    ...
    return (
        <>
            ...
            <ConfirmDialog
                ...
                message="Transfer ini akan dibatalkan dan saldo akan dikembalikan ke wallet asal. Tindakan ini tidak dapat diurungkan."
