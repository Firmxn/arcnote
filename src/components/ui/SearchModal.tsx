    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} noPadding className="max-w-2xl">
            <div className="flex flex-col max-h-[80vh]">
                {/* Search Input */}
                <div className="px-4 py-3 border-b border-secondary/10 dark:border-accent/30 shrink-0">
                ...
                <div className="px-4 py-2 border-t border-secondary/10 dark:border-accent/30 shrink-0 hidden md:block">
