    ...
    return (
        <>
            ...
            <button
                ...
                className={`flex items-center gap-3 bg-white dark:bg-secondary border border-secondary/10 dark:border-accent/30 rounded-lg px-4 py-2.5 hover:border-secondary/30 dark:hover:border-white/20 transition-all duration-200 hover:shadow-md w-full max-w-md ${className}`}
                aria-label="Search"
            >
                {/* Search Icon */}
